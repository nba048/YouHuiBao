 ...
 */
public class OrderDetailFragment_4 extends BaseFragment {
    protected List<DateValueEntity> dv1;
    protected List<DateValueEntity> dv2;
    SlipAreaChart slipareachart;
    private Order orderItem;

    public OrderDetailFragment_4(Order orderItem) {
        this.orderItem = orderItem;
    }

    @Override
    protected int bindLayout() {
        return R.layout.fragment_order_detail_4;
    }

    @Override
    protected void setInitView(View mRootView) {
        this.slipareachart = (SlipAreaChart) mRootView.findViewById(R.id.slipareachart);
